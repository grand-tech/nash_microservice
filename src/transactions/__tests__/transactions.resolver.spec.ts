  ...
  validateSendFunds: () => {
    return {
      ...
      body: {
        ...
        stableCoin: 'cUSD',
        network: 'CELO',
        blockchainTransactionHash: '0xfecc30488e9837e427ac7a40774ca9442cb3a37f4553947f7026eebf57552a12',
        blockchainTransactionIndex: 0,
        transactionBlockHash: '0x30d7c4b5aca4b321435c8a9cb65d1f1732d2bd8181d46759e5adad8124ef4d3e',
